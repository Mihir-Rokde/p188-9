...
firebase=firebase.FirebaseApplication("https://c180-a4eb1-default-rtdb.firebaseio.com/",None)
...
def login(): 
    ...
    hp=encrypted_password.hexdigest()
...
def register(): 
    ...
    encrypted_password=hashlib.md5(password.encode())
    hp=encrypted_password.hexdigest()
    put_data=firebase.put('/',username,hp)
    print(hp)
